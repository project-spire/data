...
pub(crate) fn parse_id(value: &calamine::Data) -> Result<DataId, Error> {
    ...
    if i < u32::MIN as i64 || i > u32::MAX as i64 {
        return Err(Error::Parse(format!("{} is out of Id range", value.to_string())));
    }
...
pub(crate) fn parse_i8(value: &calamine::Data) -> Result<i8, Error> {
    ...
    if i < i8::MIN as i64 || i > i8::MAX as i64 {
        return Err(Error::Parse(format!("{} is out of i8 range", value.to_string())));
    }
...
pub(crate) fn parse_i16(value: &calamine::Data) -> Result<i16, Error> {
    ...
    if i < i16::MIN as i64 || i > i16::MAX as i64 {
        return Err(Error::Parse(format!("{} is out of i16 range", value.to_string())));
    }
...
pub(crate) fn parse_i32(value: &calamine::Data) -> Result<i32, Error> {
    ...
    if i < i32::MIN as i64 || i > i32::MAX as i64 {
        return Err(Error::Parse(format!("{} is out of i32 range", value.to_string())));
    }
...
pub(crate) fn parse_u8(value: &calamine::Data) -> Result<u8, Error> {
    ...
    if i < u8::MIN as i64 || i > u8::MAX as i64 {
        return Err(Error::Parse(format!("{} is out of u8 range", value.to_string())));
    }
...
pub(crate) fn parse_u16(value: &calamine::Data) -> Result<u16, Error> {
    ...
    if i < u16::MIN as i64 || i > u16::MAX as i64 {
        return Err(Error::Parse(format!("{} is out of u16 range", value.to_string())));
    }
...
pub(crate) fn parse_u32(value: &calamine::Data) -> Result<u32, Error> {
    ...
    if i < u32::MIN as i64 || i > u32::MAX as i64 {
        return Err(Error::Parse(format!("{} is out of u32 range", value.to_string())));
    }
...
pub fn parse_f64(value: &calamine::Data) -> Result<f64, Error> {
    let f = match value.get_float() {
        Some(f) => f,
        None => return Err(Error::Parse(format!("{} is not f64", value.to_string()))),
    };
...
fn parse_tuple(value: &calamine::Data, count: usize) -> Result<Vec<&str>, Error> {
    let s = match value.get_string() {
        Some(s) => s.trim(),
        None => return Err(Error::Parse(format!("{} is not a tuple string", value.to_string()))),
    };

    if s.len() < 2
        || s.chars().nth(0).unwrap() != '('
        || s.chars().nth_back(0).unwrap() != ')' {
        return Err(Error::Parse(format!("{} has an invalid tuple form", value)));
    }

    let v: Vec<&str> = s.split(", ").collect();
    if v.len() != count {
        return Err(Error::Parse(format!("{} does not match tuple count {}", value, count)));
    }
...
impl Parsable for DataId {
    fn parse(value: &calamine::Data) -> Result<Self, Error> { parse_id(value) }

    fn parse_str(s: &str) -> Result<Self, Error> {
        let id = u32::from_str(s).map_err(|_| Error::Parse(format!("{} is not a DataId", s)))?;
        Ok(DataId(id))
    }
}

impl Parsable for u8 {
    fn parse(value: &calamine::Data) -> Result<Self, Error> { parse_u8(value) }

    fn parse_str(s: &str) -> Result<Self, Error> {
        Ok(u8::from_str(s).map_err(|_| Error::Parse(format!("{} is not u8", s)))?)
    }
}

impl Parsable for u16 {
    fn parse(value: &calamine::Data) -> Result<Self, Error> { parse_u16(value) }

    fn parse_str(s: &str) -> Result<Self, Error> {
        Ok(u16::from_str(s).map_err(|_| Error::Parse(format!("{} is not u16", s)))?)
    }
}

impl Parsable for u32 {
    fn parse(value: &calamine::Data) -> Result<Self, Error> { parse_u32(value) }

    fn parse_str(s: &str) -> Result<Self, Error> {
        Ok(u32::from_str(s).map_err(|_| Error::Parse(format!("{} is not u32", s)))?)
    }
}

impl Parsable for u64 {
    fn parse(value: &calamine::Data) -> Result<Self, Error> { parse_u64(value) }

    fn parse_str(s: &str) -> Result<Self, Error> {
        Ok(u64::from_str(s).map_err(|_| Error::Parse(format!("{} is not u64", s)))?)
    }
}

impl Parsable for i8 {
    fn parse(value: &calamine::Data) -> Result<Self, Error> { parse_i8(value) }

    fn parse_str(s: &str) -> Result<Self, Error> {
        Ok(i8::from_str(s).map_err(|_| Error::Parse(format!("{} is not i8", s)))?)
    }
}

impl Parsable for i16 {
    fn parse(value: &calamine::Data) -> Result<Self, Error> { parse_i16(value) }

    fn parse_str(s: &str) -> Result<Self, Error> {
        Ok(i16::from_str(s).map_err(|_| Error::Parse(format!("{} is not i16", s)))?)
    }
}

impl Parsable for i32 {
    fn parse(value: &calamine::Data) -> Result<Self, Error> { parse_i32(value) }

    fn parse_str(s: &str) -> Result<Self, Error> {
        Ok(i32::from_str(s).map_err(|_| Error::Parse(format!("{} is not i32", s)))?)
    }
}

impl Parsable for i64 {
    fn parse(value: &calamine::Data) -> Result<Self, Error> { parse_i64(value) }
